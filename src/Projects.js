...
export default function Home() {
    ...
    return (
        ...
        <div className='project' >
            <h3 name='mazeapp' onClick={clickhandler}>MAZE APP 🧩</h3>
        ...
        <div className='project' >
            <h3 name='countries' onClick={clickhandler}>COUNTRIES 🌍</h3>
        ...
        <div className='project' name='bookdirectory' onClick={clickhandler}>
            <h3 name='bookdirectory' onClick={clickhandler}>BOOK DIRECTORY 📚</h3>
